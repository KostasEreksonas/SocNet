...
class Post {
    ...
    public function loadPostsFriends($data, $limit) {
        ...
        $str = ""; // String to return (initialize here)
        ...
        if (mysqli_num_rows($data_query) > 0) {
            ...
            while ($row = mysqli_fetch_array($data)) {
                ...
                // Prepare user_to string so it can be included even if not posted to an user
                if ($row['user_to'] == "none") {
                    $user_to = "";
                } else {
                ...
                $interval = $start_date->diff($end_date); // Difference between end and start dates
                if ($interval->y >= 1) {
                    if ($interval == 1) {
